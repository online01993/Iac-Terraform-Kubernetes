...
#Count for CPU VM master node
global_master_cpu_count = 1
#Count for CPU VM worker node
global_vm_cpu_count = 1
#Count for MEM VM master node
global_master_memory_size_gb = 1
#Count for CPU VM worker node
global_vm_memory_size_gb = 1
