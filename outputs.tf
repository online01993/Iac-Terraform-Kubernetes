...
output "k8s-url" {
  value     = local.kubernetes-base.k8s-url
}
output "k8s-endpont" {
  value     = local.kubernetes-base.k8s-endpont
}
output "k8s_kube-token-default" {
  value     = local.k8s_kube-token-default
}
output "k8s-admin_file" {
  value     = local.kubernetes-base.k8s-admin_file
  sensitive = true
}
output "k8s-client-key-data" {
  value     = local.kubernetes-base.k8s-client-key-data
  sensitive = true
}
output "k8s-client-certificate-data" {
  value     = local.kubernetes-base.k8s-client-certificate-data
  sensitive = true
}
output "k8s-certificate-authority-data" {
  value     = local.kubernetes-base.k8s-certificate-authority-data
  sensitive = true
}